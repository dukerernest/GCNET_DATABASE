...
To build the final jar and optimize the gcnetdata application for production, run:
...
Then navigate to [http://localhost:1318](http://localhost:1318) in your browser.
